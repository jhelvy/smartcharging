...
brief <- tibble(
    ...
    `Guaranteed Range if charged for 8 hrs:` = c("25%, 50%, 75%", "It means the guranteed range if your car is charged for 8 hrs during smart charging. It shows percentage here, but will be converted to mileages."))
